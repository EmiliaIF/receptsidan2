...
router.get(
  "/search/:searchterm",
  async (req: express.Request, res: express.Response) => {
    // GET Route som kommer med searchterm, vilket sedan används för att söka
...
router.put("/:id/stars", async (req: Request, res: Response) => {
  // PUT request för att stoppa in antalet stjärnor i rating arrayen
